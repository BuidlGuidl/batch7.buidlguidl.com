...
2. Next, you'll complete [Issue #1](https://github.com/BuidlGuidl/batch7.buidlguidl.com/issues/9) and 'check in' to our smart contract by writing a contract of your own.
3. After that you'll move to [Issue #2](https://github.com/BuidlGuidl/batch7.buidlguidl.com/issues/8) and create a personal page and use a pull request(PR) to send it to the batch repo.
