  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 text-white p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <section className="card bg-white bg-opacity-5 p-6 mb-8 border border-blue-400 border-opacity-20">
        ...
        <section className="card bg-white bg-opacity-5 p-6 border border-blue-400 border-opacity-20">
          <h2 className="text-2xl font-semibold mb-4 text-blue-200">Socials</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="card bg-opacity-5 p-4 border border-blue-400 border-opacity-40">
              ...
              <p className="flex items-center">
                ...
                <a
                  ...
                  target="_blank"
                  className="ml-2 btn btn-outline btn-sm border-blue-400"
                >
                  GitHub
                </a>
              </p>
